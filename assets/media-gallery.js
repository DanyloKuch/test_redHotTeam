  ...
  customElements.define(
    ...
    class MediaGallery extends HTMLElement {
      constructor() {
        ...
        // Ініціалізація Swiper з налаштуваннями з schema
        if (this.elements.viewer) {
          const swiperContainer =
            this.elements.viewer.querySelector(".product-gallery");
          if (swiperContainer) {
            const section = document.querySelector(
              `[data-section-id="${this.id.split("-")[1]}"]`
            );
            ...
            const enablePagination =
              section.dataset.enablePagination === "true";
            const enableNavigation =
              section.dataset.enableNavigation === "true";
            ...
            this.swiper = new Swiper(swiperContainer, {
              ...
              breakpoints: {
                640: { slidesPerView: 1 },
                768: { slidesPerView: slidesPerView >= 2 ? 2 : 1 },
      ...
      // Решта методів (onSlideChanged, setActiveMedia тощо) залишаються без змін
